...
Front-End Developer specializing in **interactive and high-performance web applications** using **React, JavaScript, and Tailwind**.  
I focus on writing **clean, maintainable code** while optimizing **user experience and performance**. Passionate about turning complex ideas into simple and seamless user experiences.
...
- Passionate about building **scalable and performant web apps**  
- Experienced with **state management, lazy loading, and code splitting**  
- Love turning **complex ideas into simple, seamless experiences**  
- Always learning and improving my **UI/UX and frontend skills**
